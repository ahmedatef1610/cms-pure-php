...
<?php
    ...
    $pusher = new Pusher\Pusher($_ENV['key'],$_ENV['secret'],$_ENV['app_id'],$options);
    //$pusher->trigger( 'notifications', 'new_user', "Hello" );
    ...
    <form method="get" class="navbar-form navbar-right" action="" id="language_form">
        <div class="form-group">
            <select name="lang" class="form-control" onchange="changeLanguage()" >
                ...
                <option value="ar" <?php if(isset($_SESSION['lang']) && $_SESSION['lang'] == 'ar'){ echo "selected"; } ?>>Arabic</option>
            </select>
        </div>
    </form>
                        ...
                        <form action="<?php echo $_SERVER['REQUEST_URI']?>" method='post' id='login-form'>
                            ...
                            <div class='form-group'>
                                ...
                                <input type='password' name='password' id='password' class='form-control'
                                    placeholder='<?php echo _PASSWORD; ?>' value="<?php echo isset($password) ? $password : '' ?>">
